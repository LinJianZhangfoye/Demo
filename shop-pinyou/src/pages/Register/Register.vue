<template>
    <div class="register-container">
        ...
        <div class="register">
            ...
            <div class="content">
                <label>确定密码:</label>
                <input placeholder="请确认你的密码" v-model="password1" name="password1" v-validate="{ required: true, is: password }" :class="{ invalid: errors.has('password1') }"/>
                <span class="error-msg">{{ errors.first("password1") }}</span>
            </div>
            <div class="controls">
                <input name="agree" type="checkbox" v-validate="{ required: true, agree: true }" :class="{ invalid: errors.has('agree') }"/>
...
export default {
    ...
    methods: {
        ...
        userRegister(){
            ...
            phone && code && password && password == password1 && this.$store.dispatch('userRegister',{phone,code,password})
